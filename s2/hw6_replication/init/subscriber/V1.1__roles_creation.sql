...
GRANT USAGE ON SCHEMA marketplace TO admin;
GRANT SELECT ON ALL TABLES IN SCHEMA marketplace TO admin;

GRANT USAGE ON SCHEMA marketplace TO app;
GRANT SELECT ON ALL TABLES IN SCHEMA marketplace TO app;

ALTER DEFAULT PRIVILEGES IN SCHEMA marketplace
    GRANT SELECT ON TABLES TO admin, app;